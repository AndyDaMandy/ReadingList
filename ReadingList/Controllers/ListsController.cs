...
namespace ReadingList.Controllers
{
    public class ListsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ListName,CreationDate,Note")] List list)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ListName,CreationDate,Note")] List list)
        {
            if (id != list.Id)
            {
                return NotFound();
